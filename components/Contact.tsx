    ...
    <section className="isolate bg-white px-6 sm:py-8 lg:px-8 mt-6 sm:mt-2" id="contact">
      ...
      <form action="#" method="POST" className="mx-auto mt-12 max-w-xl sm:mt-12">
        ...
        <div className="mt-10">
          <button
            type="submit"
            className="block w-full rounded-md bg-blue-400 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-blue-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
          >
            Envoyer
          </button>
        </div>
